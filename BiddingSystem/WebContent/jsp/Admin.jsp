   ...
   <center>
    ...
    <div id="mySidenav" class="sidenav">
     ...
     <div class="centered">
      <div class="row">
        <div class="col-lg-5">
          <img src="<%= request.getContextPath() %>/CSS/IMG_2159.PNG">
        </div>
        <div class="col-lg-7">
        <div class="col-lg-12" style="text-align:center">
          <h2>Welcome To Bidding System!</h2>
     ...
     <!--    <div class="col-lg-12">
      ...
      <div>
			  ...
			  <li>viewSellerPost:Seller Posts to be approved ("pending state to Ready for sale state")</li>
			  <li>Start Timer: Start the Timer to start an auction("Ready for sale to On timer")</li>
				<li>viewBidding: Lists all running auctions</li>
				<li>Calculate Profit: Displays the earnings</li>
			</div>
